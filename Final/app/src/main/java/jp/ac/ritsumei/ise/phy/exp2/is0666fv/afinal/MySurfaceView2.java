...
public class MySurfaceView2 extends SurfaceView implements Runnable, SurfaceHolder.Callback {
    ...
    public MySurfaceView2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        initialize(context);
    }
    public void initialize(Context context){
        gameActivity2 = (GameActivity2)context;
        sHolder = getHolder();
    ...
    public void surfaceDestroyed(@NonNull SurfaceHolder holder) {
        thread = null;
        gameActivity2.stopSensing();
    }
    GameActivity2 gameActivity2;
    ...
    private float accelX; //手球のx方向加速度
    private float accelY; //手球のy方向加速度
    ...
    private void drawCanvas(){
        ...
        c.drawColor(0xFF2863AB) ; //背景色はコバルトブルー
        ...
        if(gameFinished == false){
            ...
            if(isTouchUp){
                ...
                if(Math.abs(velocityX) < 0.1){
                    accelX = gameActivity2.getAccX();
                    velocityX = -accelX * 4/5;
                }
                if(Math.abs(velocityY) < 0.1){
                    accelY = gameActivity2.getAccY();
                    velocityY = accelY * 4/5;
                }
